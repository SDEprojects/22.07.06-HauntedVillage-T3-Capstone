...
//        playerInfoList = com.game.HauntedVillage.RestorePlayer.restorePlayer();
...
//        com.game.HauntedVillage.SavePlayer.savePlayer(player.getLocation(), player.getInventory(), player.getHealthLevel(), player.getNpcInventory());
//    }
//
...
//                        if (item.equals(noun)) {
//                            com.game.HauntedVillage.Sound.runFX();
...
//                com.game.HauntedVillage.Art.showArt("candle");
...
//        com.game.HauntedVillage.Art.showArt("demon");
...
//        com.game.HauntedVillage.Art.showArt("house");
